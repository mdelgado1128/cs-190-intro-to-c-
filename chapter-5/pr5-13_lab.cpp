...
int main()
{
  ...
  double studentsAverage = 0.0; // Average test score for all students
  double classAverage;          // Average test score for the class
  ...
  for (int snum = 1; snum <= numStudents; snum++) //Outer loop
  {
    ...
    cout << " is " << average << "\n\n";
    cout << studentsAverage << endl;
  } //End outer loop
  classAverage = studentsAverage / numStudents;
  cout << "The average score for all students " << classAverage << endl;
